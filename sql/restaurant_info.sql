...
('PizzaHut@plaza singapura', 'Rochor'),
...
('combo(for 2 pax)', 35, '4 Fingers@plaza singapura', 'Seafood Rice Box -1 4 Fingers Crispy Chicken Special (24pcs) -1\r\n'),
('Combo(for 3 pax)', 42, '4 Fingers@plaza singapura', '4 Fingers Crispy Chicken (12pcs) -1 Chicken Katsu Sandwich -1 Chicken Chop -1Chicken Burger -1\r\n'),
('Combo(for 4-6 pax)', 80, '4 Fingers@plaza singapura', '4 Fingers Crispy Chicken Special (50pcs) -1Tofu (2pcs) Rice Box -1Chicken Wrap -1Seaweed Red Pepper Skinny Fries (S) -4'),
